...
memnum=1
df.to_csv("C:\\Users\\itis\\Documents\\memristive-brain\\memristors\\Organic memristors measurements\\mem_test\\small_memes\\small_memr{}.csv".format(memnum), index=False)
