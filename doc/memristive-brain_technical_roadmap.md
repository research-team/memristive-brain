...
'AT:TODO': Need to add specific, real live examples.
...
There are three parts of the block diagram represented in colors: excitatory – orange, inhibitory – blue, modulatory – green (which is coveres all biological action types).
